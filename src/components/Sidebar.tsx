...
const links = [
  ...
  { href: "/partner", label: "Unsere Partner", icon: HandshakeIcon },
];
...
function HandshakeIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg {...props} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M2 12l4-4 4 3 3-3 2 2" />
      <path d="M12 10l3-3 4 4-3 3-2-2" />
      <path d="M8 11l3 3 2-2" />
      <path d="M6 8l-2 2 5 5 2-2" />
      <path d="M18 8l2 2-5 5-2-2" />
    </svg>
  );
}
