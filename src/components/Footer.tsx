    ...
    <footer className="bg-white border-t border-stone-200 mt-16">
      <div className="max-w-6xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-stone-600">
            <li><Link href="/ueber-uns" className="hover:text-[var(--color-maroon)]">Über uns</Link></li>
            <li><Link href="/projekte" className="hover:text-[var(--color-maroon)]">Projekte</Link></li>
            <li><Link href="/mitwirken" className="hover:text-[var(--color-maroon)]">Mitwirken</Link></li>
            <li><Link href="/der-verein" className="hover:text-[var(--color-maroon)]">Der Verein</Link></li>
            <li><Link href="/kontakt" className="hover:text-[var(--color-maroon)]">Kontakt</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div className="flex gap-3 text-stone-500">
            <a href="#" aria-label="Facebook" className="hover:text-[var(--color-maroon)]">
            ...
            <a href="#" aria-label="Instagram" className="hover:text-[var(--color-maroon)]">
            ...
            <a href="#" aria-label="X" className="hover:text-[var(--color-maroon)]">
      ...
      <div className="border-t border-stone-200 py-6 text-center">
        <p className="font-display text-sm text-stone-500">
          ...
          <span className="text-[var(--color-navy)]">Verbinden.</span>{" "}
